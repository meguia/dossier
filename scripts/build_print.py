...
def footer(n,title,total=None):
    ...
    return f'<footer class="page-footer"><span>Manuel Eguía / {E(title)}</span><span>{n:02d} / {count}</span></footer>'
...
def main():
    ...
    cover=f'<div class="cover-top"><span class="cover-name">Manuel Eguía</span><span>Selected works &amp; practice<br>2026</span></div><div class="cover-main"><div><h1>Sound,<br>space &amp;<br><em>perception.</em></h1><p class="role">Sound artist · Physicist · Researcher<br>Buenos Aires, Argentina</p><div class="small-links"><a href="https://vimeo.com/meguia">Vimeo ↗</a><a href="https://www.youtube.com/@manueleguia2915">YouTube ↗</a><a href="{D["base_url"]}">Website ↗</a></div></div><figure>{img("sonic-performer.jpg","cover-image",sonic["en"]["alt"])}<figcaption class="caption">Sonic Crystal Room · Manuel Eguía / Oscar Edelstein</figcaption></figure></div>'
    pages.append(page(len(pages)+1,'Sound, space & perception',cover,'cover'))
    ...
    pages.append(page(len(pages)+1,'Position & biography',statement))
    ...
    transit=f'<p class="eyebrow">Transit / Site-specific virtual reality</p><h2>{E(td["detail_title"])}</h2><div class="two-columns"><div class="body">{paras(td["detail"])}</div><div><p class="large-summary">A virtual journey that begins<br>and ends in the same room.</p><p class="small muted">First episode: iM Konsthall, Moskosel, Sweden, 2023.<br>Manuel Eguía / Mauro Zannoli<br>Commission: Northern Sustainable Futures</p>{links(transit_project)}</div></div><div class="transit-sequence">{sequence}</div>'
