...
def homepage(lang):
    ...
    body=f'''<main id="main"><div class="wrap"><section class="hero"><div class="hero-top eyebrow"><span class="dot">{E(t['role'])}</span><span>{E(t['portfolio'])} / 2026</span></div><div class="hero-grid"><div><h1>{hero_title}</h1><p class="hero-text">{E(t['intro'])}</p>{downloads(lang,prefix)}</div><figure>{image('sonic-performer.jpg',DATA['projects'][0][lang]['alt'],prefix,'hero-image',True)}<figcaption class="caption"><span>01 / {E(DATA['projects'][0][lang]['title'])}</span><span>Manuel Eguía / Oscar Edelstein</span></figcaption></figure></div><div class="hero-bottom"><span class="eyebrow">Physics / Nonlinear dynamics / Neuroscience / Acoustics</span>{channels()}</div></section><section class="section" id="works"><div class="section-heading"><div><p class="eyebrow">01—04</p><h2>{E(t['work_heading'])}</h2></div><p>{E(t['work_intro'])}</p></div><div class="works-grid">{cards}</div></section></div><section class="statement-section section" id="practice"><div class="wrap statement-grid"><div><p class="eyebrow">{'Position & biography' if lang=='en' else 'Posición y biografía'}</p><h2>{E(t['statement_title'])}</h2><div class="portrait-row">{image('portrait.jpg','Manuel Eguía',prefix)}<p>{E(t['bio'])}</p></div></div><div class="statement-copy">{paras(t['statement'])}</div></div></section><div class="wrap"><section class="section practice-grid"><div><h2>{E(t['practice_heading'])}</h2>{paras(t['practice'])}<div class="current"><p class="eyebrow">{'Work in progress' if lang=='en' else 'Trabajo en proceso'}</p><h4>{E(t['current_heading'])}</h4><p>{E(t['current'])}</p></div></div><div><h3>{E(t['workshop_heading'])}</h3><p>{E(t['workshop_intro'])}</p>{rows(t['workshops'])}<a class="text-link" href="https://www.pa-f.net/book/export/html/47">Performing Arts Forum ↗</a></div></section><section class="section collab-section"><div class="section-heading"><h3>{E(t['collab_heading'])}</h3><p>{E(t['collab_intro'])}</p></div>{rows(t['collaborations']).replace('class="list"','class="list collab-list"')}</section><section class="section cv-section" id="cv"><div class="section-heading"><h2>{E(t['cv_heading'])}</h2><div><p>{E(t['cv_intro'])}</p>{downloads(lang,prefix)}</div></div><div class="cv-columns"><div><h3>{E(l['positions'])}</h3>{rows(t['positions'])}<p class="programme">{E(t['programme'])}</p><h3>{E(l['education'])}</h3>{rows(t['education'])}</div><div><h3>{E(l['highlights'])}</h3>{rows(t['highlights'])}</div></div>{research(lang)}</section></div></main>'''
